...
#define SB_OUTDOR 201
#define SB_CEILING 202
#define SB_LAMP 203
#define SB_MATRIX SB_OUTDOR
//#define SB_MATRIX SB_CEILING
...
// ******************* ПОДКЛЮЧЕНИЕ К СЕТИ *******************
                                             ...
                                             // 
#define NETWORK_SSID "Zone Host Six G"                      // Имя WiFi сети - пропишите здесь или задайте из программы на смартфоне
#define NETWORK_PASS "Vek is the best"                      // Пароль для подключения к WiFi сети - пропишите здесь или задайте из программы на смартфоне
...
byte IP_STA[] = {10,152,152,SB_MATRIX};          // Статический адрес матрицы в локальной сети WiFi
 ...
 */ 
  ...
  #define PIN_BTN 4            // физический D6 кнопка подключена сюда (PIN --- КНОПКА --- GND)
  #define SRX D6                // физический D4 is RX of ESP8266, connect to TX of DFPlayer
  #define STX D5                // физический D3 is TX of ESP8266, connect to RX of DFPlayer module
#endif
  ...
  #define SRX 0                // физический D4 is RX of ESP8266, connect to TX of DFPlayer
  #define STX 0                // физический D3 is TX of ESP8266, connect to RX of DFPlayer module
#endif

#if (SB_MATRIX == SB_CEILING)
  #define WIDTH 21              // ширина матрицы
...
#define D_TEXT_SPEED 80      // скорость бегущего текста по умолчанию (мс)
...
#define D_GAME_SPEED 180      // скорость игр по умолчанию (мс)
#define D_GAME_SPEED_MIN 25
#define D_GAME_SPEED_MAX 375

#define D_GIF_SPEED 255       // скорость гифок (мс)
...
#define MAX_EFFECT                 24 // 25 // 29 // количество эффектов, определенных в прошивке
...
String TEXT_1 = "Счастья и Бобра!";
String TEXT_2 = "2019  .   .   .   .   .   .   .   2020";
String TEXT_3 = "С НОВЫМ ГОДОМ!!!";
String TEXT_4 = "ДО НОВОГО ГОДА ОСТАЛОСЬ ";
